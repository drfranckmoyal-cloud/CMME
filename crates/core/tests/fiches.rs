...
fn fiches_completent_sans_dupliquer() {
    ...
    let rep = s.integrate_fiches(vec![
    ...
    assert!(s.integrate_fiches(vec![fiche("a.pages", "FICTIF Alpha", "2025-01-02", "7"), fiche("a2.pages", "FICTIF Alpha", "2025-10-06", "9"), fiche("b.pages", "FICTIF Beta", "2025-02-03", "5"), fiche("c.pages", "FICTIF Gamma", "2025-03-04", ""), Fiche { file: "vide.pages".into(), ..Default::default() }]).is_err());
}
